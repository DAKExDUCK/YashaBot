...
from modules.musicbot.audiocontroller import AudioController
from modules.musicbot.settings import GuildSettings, run_migrations, extract_legacy_settings
